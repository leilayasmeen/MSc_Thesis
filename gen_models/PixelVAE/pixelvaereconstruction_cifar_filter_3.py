...
OUT_DIR = 'reconstructions_cifar_filter_3'
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
            ...
            for imagenum in range(numsamples):
                ...
                for k in range(NUM_CLASSES):
                  ...
                  color_grid_vis(
                     ...
                     1, 
                     1, 
                     'reconstruction_filter_3_class{}_{}.png'.format(k,imagenum)
                  )
    ...
    lib.sampling_loop_cifar_filter_3.sampling_loop( #LEIlAEDIT : changed to sampling loop file. TODO: update to remove uncessary arguments
        session=session,
