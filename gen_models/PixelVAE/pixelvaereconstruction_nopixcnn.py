...
OUT_DIR = 'reconstructions_mnist_nopixcnn'
...
import random
import tflib as lib
import tflib.sampling_loop_nopixcnn
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    lib.sampling_loop_nopixcnn.sampling_loop( #LEIlAEDIT : changed to sampling loop file. TODO: update to remove uncessary arguments
        session=session,
