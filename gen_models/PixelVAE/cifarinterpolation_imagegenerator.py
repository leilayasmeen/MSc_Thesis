...
OUT_DIR = DATASET + '_interpolation_comparisons'
            ...
            for imagenum in range(numsamples):
                for class1 in range(NUM_CLASSES-1): # goes up to class 8
                  ...
                  for class2 in range(class1+1, NUM_CLASSES):
                    ...
                    # SLERP calculations: find angle between the two latent codes
                    ...
                    for p in pvals:
                      ...
                      for y in xrange(HEIGHT):
                        for x in xrange(WIDTH):
                              for ch in xrange(N_CHANNELS):
                                  next_sample_slerp = dec1_fn(new_code_slerp, samples_slerp, ch, y, x) 
                                  samples_slerp[:,ch,y,x] = next_sample_slerp
