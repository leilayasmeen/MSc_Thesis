...
OUT_DIR = DATASET + '_interpolation1_final_filter_3_mean_beta_largesample_8'
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    if MODE == 'one_level':
        ...
        def generate_and_save_samples(tag):
            ...
            np.save(OUT_DIR + '/' + 'x_augmentation_array_mean_beta_largesample_8', x_augmentation_array) #LEILAEDIT for .npy saving
            np.save(OUT_DIR + '/' + 'y_augmentation_array_mean_beta_largesample_8', y_augmentation_array) #LEILAEDIT for .npy saving   
