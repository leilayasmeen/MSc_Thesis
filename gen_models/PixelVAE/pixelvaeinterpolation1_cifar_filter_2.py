...
import random
import tflib as lib
import tflib.sampling_loop_cifar_filter_2
...
OUT_DIR = 'linear_interpolations_' + DATASET + '_filter_2'
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    lib.sampling_loop_cifar_filter_2.sampling_loop( #LEIlAEDIT : changed to sampling loop file. TODO: update to remove uncessary arguments
        session=session,
