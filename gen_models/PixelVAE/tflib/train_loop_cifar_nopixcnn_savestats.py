...
PARAMS_FILE = 'params_cifar_nopixcnn_savestats.ckpt'
TRAIN_LOOP_FILE = 'train_loop_cifar_nopixcnn_savestats.pkl'
TRAIN_OUTPUT_FILE = 'train_output_cifar_nopixcnn_savestats.ndjson'
