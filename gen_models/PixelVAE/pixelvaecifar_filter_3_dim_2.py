...
import tflib as lib
import tflib.train_loop_cifar_filter_3_dim_2
...
OUT_DIR = DATASET + '_results' + '_filter_3_dim_2'
...
if SETTINGS == 'mnist_256':
    ...
    LATENT_DIM_2 = 2 #LEILA EDIT2: was previously 256
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    lib.train_loop_cifar_filter_3_dim_2.train_loop(
        session=session,
