...
OUT_DIR = DATASET + '_interpolation3_final_filter_3_mean_beta'
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    if MODE == 'one_level':
        ...
        def generate_and_save_samples(tag):
            ...
            np.save(OUT_DIR + '/' + 'x_augmentation_array_interpol3_mean_beta', x_augmentation_array) #LEILAEDIT for .npy saving
            np.save(OUT_DIR + '/' + 'y_augmentation_array_interpol3_mean_beta', y_augmentation_array) #LEILAEDIT for .npy saving   
