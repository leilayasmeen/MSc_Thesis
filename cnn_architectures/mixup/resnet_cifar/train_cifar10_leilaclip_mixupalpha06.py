...
if __name__ == '__main__':
    ...
    training_generator = MixupGenerator(x_train45, y_train45, batch_size=batch_size, alpha=0.6, datagen=datagen)() # LEILAEDIT
    ...
    resnet.save('resnet_110_45kclip_mixupalphapoint6.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_mixupalphapoint6.p', 'wb') as f:
