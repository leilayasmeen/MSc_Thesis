...
seed = 333
weights_file_10 = "resnet_110_45kclip_mixup_baseline_11250.h5"
...
if __name__ == '__main__':
    ...
    x_train45_additions = x_train45_additions[0:11249,:]
    y_train45_additions = y_train45_additions[0:11249,:]
    ...
    evaluate_model(model, weights_file_10, x_test, y_test, bins = 15, verbose = True, 
                   pickle_file = "probs_resnet110_c10clip_mixup_baseline_11250", x_val = x_val, y_val = y_val)
