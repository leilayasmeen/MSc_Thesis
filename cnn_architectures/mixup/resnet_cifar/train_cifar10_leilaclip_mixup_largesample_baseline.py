...
batch_size         = 128
epochs             = 200
iterations         = 90000 // batch_size #LEILAEDIT
weight_decay       = 0.0001
seed = 333
...
if __name__ == '__main__':
    ...
    resnet.save('resnet_110_45kclip_mixup_largesample_baseline.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_mixup_largesample_baseline.p', 'wb') as f:
