...
if __name__ == '__main__':
    ...
    training_generator = MixupGenerator(x_train45, y_train45, batch_size=batch_size, alpha=0.2, p = 0.1, datagen=datagen)() # LEILAEDIT
    ...
    resnet.save('resnet_110_45kclip_mixup_varyprop.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_mixup_varyprop.p', 'wb') as f:
