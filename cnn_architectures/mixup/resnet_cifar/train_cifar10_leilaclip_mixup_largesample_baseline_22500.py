...
batch_size         = 128
epochs             = 200
iterations         = 67500 // batch_size #LEILAEDIT
weight_decay       = 0.0001
seed = 333
...
if __name__ == '__main__':
    ...
    x_train45_additions = x_train45_additions[0:22500,:]
    y_train45_additions = y_train45_additions[0:22500,:]
    ...
    resnet.save('resnet_110_45kclip_mixup_largesample_baseline_22500.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_mixup_largesample_baseline_22500.p', 'wb') as f:
