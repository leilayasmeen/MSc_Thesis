...
batch_size         = 128
epochs             = 200
iterations         = 46125 // batch_size
weight_decay       = 0.0001
mean = [125.307, 122.95, 113.865]  # Mean (per-pixel mean?) 
std  = [62.9932, 62.0887, 66.7048]
seed = 333
weights_file_10 = "resnet_110_45kclip_mixup_nonbeta_baseline_1125.h5"
...
if __name__ == '__main__':
    ...
    x_train45_additions = np.load('Augmentation_Sets/x_augmentation_array_mixup_nonbeta_baseline.npy')
    x_train45_additions = x_train45_additions.transpose(0,2,3,1)
    y_train45_additions = np.load('Augmentation_Sets/y_augmentation_array_mixup_nonbeta_baseline.npy')
    y_train45_additions = y_train45_additions.reshape(-1,num_classes10)
    
    # shorten to applicable size
    x_train45_additions = x_train45_additions[0:1125,:]
    y_train45_additions = y_train45_additions[0:1125,:]
    ...
    evaluate_model(model, weights_file_10, x_test, y_test, bins = 15, verbose = True, 
                   pickle_file = "probs_resnet110_c10clip_mixup_nonbeta_baseline_1125", x_val = x_val, y_val = y_val)
