...
batch_size         = 128
epochs             = 200
iterations         = 47250 // batch_size
weight_decay       = 0.0001
mean = [125.307, 122.95, 113.865]  # Mean (per-pixel mean?) 
std  = [62.9932, 62.0887, 66.7048]
seed = 333
weights_file_10 = "resnet_110_45kclip_mixup_nonbeta_baseline_2250.h5"
...
if __name__ == '__main__':
    ...
    evaluate_model(model, weights_file_10, x_test, y_test, bins = 15, verbose = True, 
                   pickle_file = "probs_resnet110_c10clip_mixup_nonbeta_baseline_2250", x_val = x_val, y_val = y_val)
