...
batch_size         = 128
epochs             = 200
iterations         = 45560 // batch_size #LEILAEDIT
weight_decay       = 0.0001
seed = 333
...
if __name__ == '__main__':
    ...
    x_train45_additions = x_train45_additions[0:560,:]
    y_train45_additions = y_train45_additions[0:560,:]
    ...
    resnet.save('resnet_110_45kclip_mixup_nonbeta_baseline_560.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_mixup_nonbeta_baseline_560.p', 'wb') as f:
