...
if __name__ == '__main__':
    ...
    x_train45_additions = np.load('Augmentation_Sets/x_augmentation_array_interpol3_560mean_beta.npy')
    x_train45_additions = x_train45_additions.transpose(0,2,3,1)
    y_train45_additions = np.load('Augmentation_Sets/y_augmentation_array_interpol3_560mean_beta.npy')
    ...
    resnet.save('resnet_110_45kclip_aug3_560mean_beta.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_aug3_560mean_beta.p', 'wb') as f:
