# 64 Load in model weights and evaluate its goodness (ECE, MCE, error) also saves logits.
...
weight_decay       = 0.0001
seed = 333
weights_file_100 = "resnet_110_45k_c100clip.h5"
...
if __name__ == '__main__':
    ...
    evaluate_model(model2, weights_file_100, x_test, y_test, bins = 15, verbose = True, 
                   pickle_file = "probs_resnet110_c100clip", x_val = x_val, y_val = y_val)
