...
if __name__ == '__main__':
    ...
    x_train45_additions = np.load('Augmentation_Sets/x_augmentation_array_interpol4_1125mean.npy')
    x_train45_additions = x_train45_additions.transpose(0,2,3,1)
    y_train45_additions = np.load('Augmentation_Sets/y_augmentation_array_interpol4_1125mean.npy')
    ...
    resnet.save('resnet_110_45kclip_aug_interpol4_1125mean.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_aug_interpol4_1125mean.p', 'wb') as f:
