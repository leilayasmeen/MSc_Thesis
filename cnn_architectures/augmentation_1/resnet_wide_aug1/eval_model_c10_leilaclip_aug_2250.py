...
weight_decay       = 0.0005
seed = 333
weights_file_10 = "resnet_wide_28_10_c10clip_aug_2250.h5"  # Weight file path
...
if __name__ == '__main__':
    ...
    x_train = np.load('Augmentation_Sets/x_augmentation_array_2250.npy')
    y_train = np.load('Augmentation_Sets/y_augmentation_array_2250.npy')
    ...
    evaluate_model(model, weights_file_10, x_test, y_test, bins = 15, verbose = True, 
                   pickle_file = "probs_resnet_wide32_c10clip_aug_2250", x_val = x_val, y_val = y_val)
