...
batch_size         = 128
epochs             = 200
iterations         = 46125 // batch_size #LEILAEDIT from 45000
weight_decay       = 0.0001
seed = 333
...
if __name__ == '__main__':
    ...
    x_train45_additions = np.load('Augmentation_Sets/x_augmentation_array_mean_beta_largesample_1125.npy')
    x_train45_additions = x_train45_additions.transpose(0,2,3,1)
    y_train45_additions = np.load('Augmentation_Sets/y_augmentation_array_mean_beta_largesample_1125.npy')
    ...
    resnet.save('resnet_110_45kclip_augmean_beta_largesample_1125.h5')
    ...
    with open('hist_110_cifar10_v2_45kclip_augmean_beta_largesample_1125.p', 'wb') as f:
