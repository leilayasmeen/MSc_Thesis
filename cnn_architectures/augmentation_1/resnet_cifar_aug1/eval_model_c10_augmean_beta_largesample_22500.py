...
batch_size         = 128
epochs             = 200
iterations         = 67500 // batch_size
weight_decay       = 0.0001
mean = [125.307, 122.95, 113.865]  # Mean (per-pixel mean?) 
std  = [62.9932, 62.0887, 66.7048]
seed = 333
weights_file_10 = "resnet_110_45kclip_augmean_beta_largesample_22500.h5"
...
if __name__ == '__main__':
    ...
    x_train_additions = np.load('Augmentation_Sets/x_augmentation_array_mean_beta_largesample_22500.npy')
    y_train_additions = np.load('Augmentation_Sets/y_augmentation_array_mean_beta_largesample_22500.npy')
    ...
    evaluate_model(model, weights_file_10, x_test, y_test, bins = 15, verbose = True, 
                   pickle_file = "probs_resnet110_c10clip_augmean_beta_largesample_22500", x_val = x_val, y_val = y_val)
