...
if __name__ == '__main__':
    ...
    (x_train_additions) = np.load('/Users/wildflowerlyi/Desktop/linear_interpolations_cifar/x_augmentation_array.npy')
    (y_train_additions) = np.load('/Users/wildflowerlyi/Desktop/linear_interpolations_cifar/y_augmentation_array.npy')
    
    x_train_additions = x_train_additions.transpose(0, 2, 3, 1) # reorder columns to match the keras order, CHANNELS last
    y_train_additions = y_train_additions.reshape(-1, num_classes) # reshape to allow concatenation
