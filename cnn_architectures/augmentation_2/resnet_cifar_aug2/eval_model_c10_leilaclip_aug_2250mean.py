...
seed = 333
weights_file_10 = "resnet_110_45kclip_aug_interpol2_2250mean.h5"
...
if __name__ == '__main__':
    ...
    x_train_additions = np.load('Augmentation_Sets/x_augmentation_array_interpol2_2250mean.npy')
    y_train_additions = np.load('Augmentation_Sets/y_augmentation_array_interpol2_2250mean.npy')
    ...
    evaluate_model(model, weights_file_10, x_test, y_test, bins = 15, verbose = True, 
                   pickle_file = "probs_resnet110_c10clip_aug_interpol2_2250mean", x_val = x_val, y_val = y_val)
